import XCTest
@testable import SwiftyBinarySearch
...
final class binarySearchAndInsert_in_int_array_and_return: XCTestCase {
	...
	func test_value_exist() {
		...
		let array1 = [1, 2, 3, 5]
		let array2 = binarySearchAndInsert(for: 2, in: array1)
	...
	func test_value_does_not_exist() {
		...
		let array1 = [1, 2, 3, 5]
		let array2 = binarySearchAndInsert(for: 4, in: array1)
	...
	func test_value_under_lower_bound() {
		...
		let array1 = [1, 2, 3, 5]
		let array2 = binarySearchAndInsert(for: 0, in: array1)
	...
	func test_value_above_upper_bound() {
		...
		let array1 = [1, 2, 3, 5]
		let array2 = binarySearchAndInsert(for: 10, in: array1)
...
final class binarySearchAndInsert_in_int_array_in_place: XCTestCase {
	...
	func test_value_exist() {
		...
		var array = [1, 2, 3, 5]
		binarySearchAndInsert(for: 2, in: &array)
	...
	func test_value_does_not_exist() {
		...
		var array = [1, 2, 3, 5]
		binarySearchAndInsert(for: 4, in: &array)
	...
	func test_value_under_lower_bound() {
		...
		var array = [1, 2, 3, 5]
		binarySearchAndInsert(for: 0, in: &array)
	...
	func test_value_above_upper_bound() {
		...
		var array = [1, 2, 3, 5]
		binarySearchAndInsert(for: 10, in: &array)
...
final class convenience_function: XCTestCase {
	...
	func test_convenient_function_searchAndInsert() {
		...
		let array1 = [1, 2, 3, 5]
		let array2 = searchAndInsert(for: 2, in: array1)
	...
	func test_convenient_function_searchAndInsert_in_place() {
		...
		var array = [1, 2, 3, 5]
		searchAndInsert(for: 2, in: &array)
